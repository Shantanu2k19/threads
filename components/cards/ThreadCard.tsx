...
const ThreadCard = ({ 
    ...
    console.log("hello thread card");
    return (
        <article className={`flex w-full flex-col rounded-x1 
                    ...
                    <div className="flex w-full flex-col">
                        ...
                        <div className="mt-5 flex flex-col gap-3">
                            ...
                            {isComment && comments.length > 0 && (
                                <Link href={`/thread/${id}`}>
                                    <p className="mt-1 test-subtle-medium text-gray-1">{comments.length} replies</p>
                                </Link>
                            )}
                        </div>                     
                    </div>
